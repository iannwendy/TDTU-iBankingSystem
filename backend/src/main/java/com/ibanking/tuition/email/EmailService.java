...
public class EmailService {
    ...
    public void sendOtpEmail(Customer payer, String otp, PaymentTransaction txn, StudentTuition tuition) {
        // For debugging - just log the OTP to console
        System.out.println("=== OTP EMAIL DEBUG ===");
        System.out.println("Customer: " + payer.getFullName() + " (" + payer.getEmail() + ")");
        System.out.println("Student ID: " + tuition.getStudentId());
        System.out.println("Amount: " + tuition.getAmount());
        System.out.println("Transaction ID: " + txn.getId());
        System.out.println("OTP CODE: " + otp);
        System.out.println("=======================");
        
        // Skip email sending for now - just log the OTP
        System.out.println("Email sending disabled for debugging");
    }
